...
from infrastructure.implementation.repository.mapper.parents_repository_mapper import get_parents_mapper
...
class ParentsRepositoryImpl(ParentsRepository):
    ...
    def find_by_student_uuid(self, uuid: str, student_uuid: str, x_request_id: str) -> Optional["Parents"]:
        return get_parents_mapper(self.auth.get_parents_with_student_uuid(uuid, student_uuid, x_request_id))