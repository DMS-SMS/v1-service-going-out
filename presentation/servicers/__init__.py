from proto.python.outing import outing_student_pb2_grpc, outing_teacher_pb2_grpc, outing_parents_pb2_grpc
...
def register_outing_servicers(app):
    ...
    outing_parents_pb2_grpc.add_OutingParentsServicer_to_server(ParentsOutingServicer(), app)